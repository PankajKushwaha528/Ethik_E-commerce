  ...
  return (
    <div className='bg-gray-950'>
      <div className='max-w-7xl mx-auto items-center flex flex-col py-8 px-4 md:px-8 min-h-screen'>
        ...
        className='text-gray-300 text-center max-w-xl mb-12'>Have questions about our vegan products, orders, or anything else? We're here to help. Reach out and a member of Team Ethik will get back to you shortly.</motion.p>
            ...
            <div className='flex-1'>
              ...
              <div className='text-gray-950 flex gap-2 items-center'>
                ...
                <p className='text-gray-950 mt-4'>
                  phone: +91 9119 02 9119
                </p>
              </div>
              <div className='text-gray-950 flex gap-2 items-center'>
                <Mail fill='#33CCCC' className='text-gray-900' />
                <p className='text-gray-950'>
                  Email: hello@ethikonline.com
                </p>
              </div>
            </div>
            <div>
              ...
              <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.1810927832807!2d77.58638097358882!3d12.960261115129788!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae167c4332a125%3A0x9ce7f654e81bbe67!2sEthik%20-%20Live%20Leather%20Free!5e0!3m2!1sen!2sin!4v1753385889407!5m2!1sen!2sin" 
